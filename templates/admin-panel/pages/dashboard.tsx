  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        <CardDataStats title="Total Users" total="3,456" rate="4.35%" levelUp>
          <UsersIcon className="h-6 w-6" />
        </CardDataStats>

        <CardDataStats title="Total Orders" total="2,450" rate="2.59%" levelUp>
        ...
        <CardDataStats title="Growth Rate" total="12.5%" rate="0.43%" levelDown>
